/*
 Programme : NombreHabitant
 But :  fonction qui retourne le nombre d'habitant dans une ville dont le code postale est donné
...
//Fonctions
Adresse nbreHabitant(const Personne &unePersonne);
...
int main(void)
{
    int a;
    int i;
    const unsigned int NBRE_EMPLOYES = 95;   // nombre d'employés dans la structure
    ...
    cout <<"De quel code postale souhaitez-vous connaitre le nombre d'habitants ? " ;
    cin >> a;
